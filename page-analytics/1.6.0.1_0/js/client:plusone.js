...
(function () {
    ...
    var Q = k, R = q, Ha = Q[A], Ia = function () {
    }, Ja = /\[native code\]/, S = function (a, b, c) {
        return a[b] = a[b] || c
    }, Ka = function (a) {
        ...
        return r(a)[s](Ma, "&amp;")[s](Na, "&lt;")[s](Oa, "&gt;")[s](Pa, "&quot;")[s](Qa, "&#39;")
    }, T = function () {
        var a;
        if ((a = ba.create) && Ja[G](a))a = a(null); else {
            a = {};
            for (var b in a)a[b] = void 0
        }
        return a
    }, U = function (a, b) {
        return ba[K].hasOwnProperty[L](a, b)
    }, Sa = function (a) {
        if (Ja[G](ba.keys))return ba.keys(a);
        var b = [], c;
    ...
    var X = function (a, b, c) {
        ...
        return a.H + (0 < a.j[I] ? "?" + a.j[P]("&") : "") + (0 < a.o[I] ? "#" + a.o[P]("&") : "")
    }, Ya = function (a, b) {
        var c = [];
        ...
        var c = "";
        2E3 < b[I] && (c = b[Aa](2E3), b = b[Aa](0, 2E3));
    ...
    var bb = function (a, b, c, d) {
        if (Q[c + "EventListener"])Q[c + "EventListener"](a, b, !1); else if (Q[d + "tachEvent"])Q[d + "tachEvent"]("on" + a, b)
    }, cb = function () {
        var a = R.readyState;
    ...
    var rb = function (a, b, c) {
        ...
        pb[a] = !b && pb[a] || c || (new Date)[oa]();
        rb(a)
    }, ub = function (a, b, c) {
        b && 0 < b[I] && (b = tb(b), c && 0 < c[I] && (b += "___" + tb(c)), 28 < b[I] && (b = b[x](0, 28) + (b[I] - 28)), c = b, b = S(qb, "_p", T()), S(b, c, T())[a] = (new Date)[oa](), rb(a, "_p", c))
    }, tb = function (a) {
        return a[P]("__")[s](/\./g, "_")[s](/\-/g, "_")[s](/\,/g, "_")
    };
    var vb = T(), wb = [], xb = function (a) {
    ...
    var yb = /^(\/[a-zA-Z0-9_\-]+)+$/, zb = /^[a-zA-Z0-9\-_\.,!]+$/, Ab = /^gapi\.loaded_[0-9]+$/, Bb = /^[a-zA-Z0-9,._-]+$/, Fb = function (a, b, c, d) {
        var e = a[z](";"), f = vb[e[ha]()], g = null;
        f && (g = f(e, b, c, d));
        ...
        return[aa(a.T)[s](/%2C/g, ",")[s](/%2F/g, "/"), "/k=", e(a.version), "/m=", e(b), d ? "/exm=" +
            e(d) : "", "/rt=j/sv=1/d=1/ed=1", a.J ? "/am=" + e(a.J) : "", a.K ? "/rs=" + e(a.K) : "", "/cb=", e(c)][P]("")
    }, Gb = function (a) {
        "/" !== a[la](0) && xb("relative path");
        for (var b = a[Aa](1)[z]("/"), c = []; b[I];) {
            a = b[ha]();
            if (!a[I] || 0 == a[H]("."))xb("empty/relative directory"); else if (0 < a[H]("=")) {
                b.unshift(a);
                break
            }
            c[F](a)
        ...
        d = Jb(a, "am");
        a = Jb(a, "rs");
        return{T: b, version: c,
            J: d, K: a}
    }, Hb = function (a) {
        for (var b = [], c = 0, d = a[I]; c < d; ++c) {
            var e = a[c][s](/\./g, "_")[s](/-/g, "_");
            Bb[G](e) && b[F](e)
        }
        return b[P](",")
    }, Jb = function (a, b, c) {
        ...
        return null
    }, Eb = /^https?:\/\/[a-z0-9_.-]+\.google\.com(:\d+)?\/[a-zA-Z0-9_.,!=\-\/]+$/, Db = /\/cb=/g, Cb = /\/\//g, Kb = function () {
        var a = ib(Ha[D]);
    ...
    var Lb = decodeURI("%73cript"), Mb = function (a, b) {
        ...
        var n = S(nb(c), "r", []).sort(), m = S(nb(c), "L", []).sort(), p = [][ka](n), w = function (a, b) {
            if (l)return 0;
            Q.clearTimeout(h);
            m[F][E](m, C);
            var d = ((W || {}).config || {})[Ca];
    ...
    var Ub = function (a) {
        ...
        if (b)for (var c in b)b.hasOwnProperty(c) && (a[c] && b[c] && "object" === typeof a[c] && "object" === typeof b[c] && !Wb(a[c]) && !Wb(b[c]) ? Xb(a[c], b[c]) : b[c] && "object" === typeof b[c] ? (a[c] = Wb(b[c]) ? [] : {}, Xb(a[c], b[c])) : a[c] = b[c])
    }, Yb = function (a) {
        if (a && !/^\s+$/[G](a)) {
            for (; 0 == a[N](a[I] -
                1);)a = a[Aa](0, a[I] - 1);
        ...
        for (e = 0; e < d[I]; ++e)d[e][M]("gapi_processed") || (d[e][v]("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || f.innerText || f.innerHTML || "") : f = void 0, (f = Yb(f)) && b[F](f));
        a && (d = {}, Xb(d, a), c[F](d));
        d = Ub("cd");
        a = 0;
        for (b = d[I]; a < b; ++a)Xb(Vb(), d[a]);
        d = Ub("ci");
        a = 0;
        for (b = d[I]; a < b; ++a)Xb(Vb(), d[a]);
        a = 0;
        for (b = c[I]; a < b; ++a)Xb(Vb(), c[a])
    }, Z = function (a) {
        if (!a)return Vb();
        a = a[z]("/");
        for (var b = Vb(), c = 0, d = a[I]; b &&
            "object" === typeof b && c < d; ++c)b = b[a[c]];
        return c === a[I] && void 0 !== b ? b : void 0
    }, $b = function (a, b) {
        var c = a;
        if ("string" === typeof a) {
            for (var d = c = {}, e = a[z]("/"), f = 0, g = e[I]; f < g - 1; ++f)var h = {}, d = d[e[f]] = h;
            d[e[f]] = b
        }
        Zb(c)
    };
    ...
    var bc = {apppackagename: 1, callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1}, cc = !1, dc = T(), ec = function () {
        if (!cc) {
            for (var a = q[pa]("meta"), b = 0; b < a[I]; ++b) {
                var c = a[b].name[Da]();
                if (0 == c.lastIndexOf("google-signin-", 0)) {
                    var c = c[Aa](14), d = a[b].content;
                    bc[c] && d && (dc[c] = d)
                }
            }
            if (k.self !== k.top) {
    ...
    var gc = k.console, hc = function (a) {
        gc && gc.log && gc.log(a)
    };
    var ic = function () {
        return!!Y.oa
    ...
    var mc;
    var nc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/u\/(\d)\//, oc = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?\#]*)?\/b\/(\d{10,})\//, pc = function (a) {
    ...
    (function () {
        ...
        sc.prototype = new a;
        sc.H = function (a, c, d) {
            return rc[K][c][E](a, ca[K][ua][L](arguments, 2))
        }
    })();
    sc[K].reset = function () {
        this.b[0] = 1732584193;
    ...
    var tc = function (a, b, c) {
        c || (c = 0);
        var d = a.N;
        if ("string" == typeof b)for (var e = 0; 16 > e; e++)d[e] = b[N](c) << 24 | b[N](c + 1) << 16 | b[N](c + 2) << 8 | b[N](c + 3), c += 4; else for (e = 0; 16 > e; e++)d[e] = b[c] << 24 | b[c + 1] << 16 | b[c + 2] << 8 | b[c + 3], c += 4;
        for (e = 16; 80 > e; e++) {
        ...
        b = a.b[0];
        c = a.b[1];
        for (var g = a.b[2], h = a.b[3], l = a.b[4], n, e = 0; 80 > e; e++)40 > e ? 20 > e ? (f = h ^ c & (g ^ h), n = 1518500249) : (f = c ^ g ^ h, n = 1859775393) : 60 > e ? (f = c & g | h & (c | g), n = 2400959708) : (f = c ^ g ^ h, n = 3395469782), f = (b << 5 | b >>> 27) + f +
            l + n + d[e] & 4294967295, l = h, h = g, g = (c << 30 | c >>> 2) & 4294967295, c = b, b = f;
    ...
    sc[K].update = function (a, b) {
        void 0 === b && (b = a[I]);
        for (var c = b - this.c, d = 0, e = this.p, f = this.g; d < b;) {
            if (0 == f)for (; d <= c;)tc(this, a, d), d += this.c;
            if ("string" == typeof a)for (; d < b;) {
                if (e[f] = a[N](d), ++f, ++d, f == this.c) {
                    tc(this, e);
                    f = 0;
                    break
                }
    ...
    var Bc = function () {
        ...
        var b = new uc;
        a = unescape(aa(a));
        for (var c = [], d = 0, e = a[I]; d < e; ++d)c[F](a[N](d));
        b.q[Ca](c);
        a = b.q;
        b = [];
        d = 8 * a.l;
        56 > a.g ? a[Ca](a.n, 56 - a.g) : a[Ca](a.n, a.c - (a.g - 56));
        for (c = a.c - 1; 56 <= c; c--)a.p[c] = d & 255, d /= 256;
        tc(a, a.p);
    ...
    vc || (Ac = 1E6 * (screen[ja] * screen[ja] + screen[ta]), yc = zc(R.cookie + "|" + R[A] + "|" + (new Date)[oa]() + "|" + Math.random()), Cc = Z("random/maxObserveMousemove") || 0, 0 != Cc && bb("mousemove", Ec, "add", "at"));
    var Fc = function () {
        var a = Y.onl;
        if (!a) {
            a = T();
        ...
        Ua(/^\w+$/[G](a), "Unsupported id - " + a);
        Fc();
        return'onload="window.___jsl.onl.e(&#34;' + a + '&#34;)"'
    }, Ic = function (a) {
        Fc().r(a)
    };
    var Jc = {allowtransparency: "true", frameborder: "0", hspace: "0", marginheight: "0", marginwidth: "0", scrolling: "no", style: "", tabindex: "0", vspace: "0", width: "100%"}, Kc = {allowtransparency: !0, onload: !0}, Lc = 0, Mc = function (a) {
        Ua(!a || ab[G](a), "Illegal url for new iframe - " + a)
    }, Nc = function (a, b, c, d, e) {
        Mc(c.src);
        var f, g = Gc(d, c), h = g ? Hc(d) : "";
        try {
            f = a[t]('<iframe frameborder="' + Ra(r(c.frameborder)) + '" scrolling="' + Ra(r(c.scrolling)) + '" ' + h + ' name="' + Ra(r(c.name)) + '"/>')
        } catch (l) {
            f = a[t]("iframe"), g && (f.onload = function () {
                f.onload =
                    null;
                g[L](this)
            }, Ic(d))
    ...
    var Oc = /^:[\w]+$/, Pc = /:([a-zA-Z_]+):/g, Qc = function () {
        var a = pc() || "0", b = qc(), c;
        c = pc(void 0) || a;
        var d = qc(void 0), e = "";
        c && (e += "u/" + c + "/");
    ...
    var Tc = {"\b": "\\b", "\t": "\\t", "\n": "\\n", "\f": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\"}, Uc = function (a) {
        var b, c, d;
        b = /[\"\\\x00-\x1f\x7f-\x9f]/g;
        if (void 0 !== a) {
            switch (typeof a) {
                case "string":
                    return b[G](a) ? '"' + a[s](b, function (a) {
                        var b = Tc[a];
                        if (b)return b;
                        b = a[N]();
                ...
                case "object":
                    ...
                    if ("number" === typeof a[I] && !a.propertyIsEnumerable("length")) {
                        d =
                            a[I];
                        for (c = 0; c < d; c += 1)b[F](Uc(a[c]) || "null");
                        return"[" + b[P](",") + "]"
                    }
        ...
        if (!a)return!1;
        if (/^[\],:{}\s]*$/[G](a[s](/\\["\\\/b-u]/g, "@")[s](/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]")[s](/(?:^|:|,)(?:\s*\[)+/g, "")))try {
            return eval("(" + a + ")")
        } catch (b) {
        }
        return!1
    ...
    try {
        Wc = !!k[wa] && '["a"]' === k[wa].stringify(["a"]) && "a" === k[wa].parse('["a"]')[0]
    } catch (Xc) {
    }
    var Yc = function (a) {
        try {
    ...
    var cd = {se: "0"}, dd = {post: !0}, ed = {style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none"}, fd = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "), gd = S(Y, "WI", T()), hd = function (a, b, c) {
        var d, e;
        d = {};
        var f = e = a;
        ...
        f.exp = Z(g + "exp");
        if (g = Z(g + "location"))for (e = 0; e < g[I]; e++) {
            var h = g[e];
            f[h] = Q[A][h]
        }
        switch (a) {
    ...
    var vd = function (a, b) {
        ...
        for (f = 0; f < e[I]; f++) {
            ...
            l[M]("data-gapiscan") ? h = null : (0 == n[H]("g:") ? m = n[x](2) : (l = (l = r(l.className || l[M]("class"))) && sd[ia](l)) && (m = l[1]), h = !m || !(nd[m] ||
                od[m] || pd[m]) || h && m !== h ? null : m);
            h && (td[h] || 0 == g[xa][Da]()[H]("g:") || 0 != Sa(kd(g))[I]) && (g[v]("data-gapiscan", !0), S(c, h, [])[F](g))
        }
        if (b)for (var p in c)for (b = c[p], d = 0; d < b[I]; d++)b[d][v]("data-onload", !0);
        ...
        if (wd(rd || {}))for (var u in c) {
            a = c[u];
            w = 0;
            for (b = a[I]; w < b; w++)a[w].removeAttribute("data-gapiscan");
            xd(u)
        } else {
            d = [];
            for (u in c)for (a = c[u], w = 0, b = a[I]; w < b; w++)e = a[w], yd(u, e, kd(e), d, b);
            zd(p, d)
        }
    }, Ad = function (a) {
        var b =
    ...
    var xd = function (a, b) {
        var c = kb(a);
        b && c ? (c(b), (c = b.iframeNode) && c[v]("data-gapiattached", !0)) : W.load(a, function () {
        ...
        switch (Ed(b, a, f)) {
            ...
            case 1:
                ...
                if (b[O]) {
                    for (var h in c) {
                        if (f = U(c, h))f = c[h], f = !!f && "object" === typeof f && (!f[y] || f[y] === ba[K][y] || f[y] === ca[K][y]);
                        if (f)try {
                            c[h] =
                                Zc(c[h])
                        } catch (l) {
                    ...
                    b = c.ownerDocument || R;
                    m = 0;
                    do h = f.id || ["I", Lc++, "_", (new Date)[oa]()][P](""); while (b[va](h) && 5 > ++m);
                    ...
                    !C && J && (J = X(b[A][D], "id", ""),
                        C = X(b[A][D], "pfname", ""), C = J ? C + "/" + J : "");
                    u.pfname = C;
                    V(u, w);
                    (u = X(n, "rpctoken") || m.rpctoken || p.rpctoken) || (u = w.rpctoken = f.rpctoken || r(Math.round(1E8 * Bc())));
                    f.rpctoken = u;
                    u = b[A][D];
                    w = T();
                    ...
                    if ((f || {}).allowPost && 2E3 < n[I]) {
                        ...
                        -1 != navigator.userAgent[H]("WebKit") && (g = n.contentWindow.document,
                            g.open(), p = g[t]("div"), w = {}, u = h + "_inner", w.name = u, w.src = "", w.style = "display:none", Nc(b, p, w, u, f));
                        p = (f = m.j[0]) ? f[z]("&") : [];
                        f = [];
                        for (w = 0; w < p[I]; w++)u = p[w][z]("=", 2), f[F]([ea(u[0]), ea(u[1])]);
                        m.j = [];
                        p = Xa(m);
                        m = b[t]("form");
                        m.action = p;
                        ...
                        m.target = h;
                        m[B].display = "none";
                        for (h = 0; h < f[I]; h++)p = b[t]("input"), fa(p, "hidden"), p.name = f[h][0], p.value = f[h][1], m[ga](p);
                        c[ga](m);
                        m.submit();
                        m[O][za](m);
                        g && g.close();
        ...
        if (a && 1 === a.nodeType && b) {
            if (c)return 1;
            if (pd[b]) {
                if (hb[a[xa][Da]()])return(a = a.innerHTML) && a[s](/^[\s\xa0]+|[\s\xa0]+$/g, "") ? 0 : 1
            } else {
                if (od[b])return 0;
                if (nd[b])return 1
            }
    ...
    var wd = function (a) {
        ...
        for (d = 0; d < c[I]; d++)Ad(c[d])
    };
    wb[F](["platform", function (a, b, c) {
        rd = c;
        b && qd[F](b);
        Gd(Bd, a);
        ...
        function d(d) {
            ...
            if (Ld(g, b)) {
                ...
                Md(a, function () {
                    l && sb("rqd");
                    c();
                    for (var a = S(Y, "RPMQ", []), b = 0; b < a[I]; b++)a[b]({data: g, origin: h})
                })
            }
        }
    ...
    Nd[K].write = function (a, b) {
        if (!Pd[G](this.B))throw"Invalid cookie name";
    ...
    Nd.iterate = function (a) {
        for (var b = q.cookie[z](/;\s*/), c = 0; c < b[I]; ++c) {
            var d = b[c][z]("="), e = d[ha]();
            a(e, d[P]("="))
        }
    };
    ...
    Qd[K].write = function (a) {
        Rd[this.U] = a;
        return!0
    };
    Qd.iterate = function (a) {
        for (var b in Rd)Rd.hasOwnProperty(b) && a(b, Rd[b])
    };
    var Sd = "https:" === k[A][qa], Td = Sd || "http:" === k[A][qa] ? Nd : Qd, Ud = function (a) {
        var b = a[x](1), c = "", d = k[A].hostname;
        if ("" !== b) {
            c = da(b, 10);
    ...
    var ae = null, ic = function () {
        ...
        Tb("auth", {callback: function () {
            var a = Q.gapi.auth, e = {client_id: c, session_state: b};
